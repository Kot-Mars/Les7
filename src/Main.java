...
//
        ...
        TreeSet<Customer> customerTreeSet = new TreeSet<>(Comparator.comparing(o->o.getFullName()));
        TreeSet<Customer> customerTreeSet1 = new TreeSet<>(Comparator.comparing(o->o.getPhone()));
        customerTreeSet.add(customer1);
        customerTreeSet.add(customer2);
        customerTreeSet.add(customer3);
        customerTreeSet.add(customer1);

        System.out.println(customerHashSet);
        System.out.println(customerTreeSet);

        for(Map.Entry<Integer, Customer> item: phoneBook.entrySet()) {
